import 'package:button_menu/src/direction.dart';
import 'package:button_menu/src/model/botton_item.dart';
                ...
                ? FittedBox(
                    child: Column(
                      ...
                      children: [
                        ...
                        ...widget.items
                            .map((e) => IconButton(
                                  onPressed: () => widget.onItemPressed!(widget
                                      .items
                                      .indexWhere((i) => i.title == e.title)),
                                  icon: MenuIcon(
                                    icon: e.icon,
                                  ),
                                ))
